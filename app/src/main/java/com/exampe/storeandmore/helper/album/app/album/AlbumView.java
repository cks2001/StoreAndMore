...
import com.exampe.storeandmore.helper.album.impl.DoubleClickWrapper;
import com.exampe.storeandmore.helper.album.util.AlbumUtils;
import com.exampe.storeandmore.helper.album.util.SystemBar;
import com.exampe.storeandmore.helper.album.widget.ColorProgressBar;
import com.exampe.storeandmore.helper.album.widget.divider.Api21ItemDivider;
...
class AlbumView extends Contract.AlbumView implements View.OnClickListener {
    ...
    public void setupViews(Widget widget, int column, boolean hasCamera, int choiceMode) {
        ...
        int dividerSize = getResources().getDimensionPixelSize(R.dimen._4sdp);
